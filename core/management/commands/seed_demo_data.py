...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        #  - 5 phụ huynh tại TP. Huế chuẩn đặc tả + ví credit & nạp MoMo
        ...
        #    + 3 CP phân bố phường TP. Huế cho thuật toán GPS
        ...
        # ═══════════════════════════════════════════════════════════════
        self._log("\n[6b/12] Tạo dữ liệu mẫu mở rộng (100% TP. Huế, 10 CP đặc tả, bookings 100% kịch bản)...")

        # ---- 6B.1. Phụ huynh bổ sung (100% TP. Huế) ----
        extra_parents = [
            {
                "username": "parent_lan", "first_name": "Mai Lan", "last_name": "Nguyễn",
                "email": "mailan.nguyen@gmail.com", "phone_number": "0908010101",
                "address": "48 Võ Thị Sáu, P. Vĩnh Ninh, TP. Huế",
                "lat": 16.4620, "lng": 107.5940, "credit": 2000000,
            ...
            },
            {
                ...
                "address": "12 Nguyễn Tri Phương, P. Phú Hòa, TP. Huế",
                "lat": 16.4560, "lng": 107.5980, "credit": 1500000,
            ...
            },
            {
                ...
                "address": "35 Lê Lợi, P. Vĩnh Ninh, TP. Huế (gần Tiểu học Lê Lợi)",
                "lat": 16.4640, "lng": 107.5905, "credit": 1200000,
                "credit_note": "Nạp credit — đăng ký đón bé hàng ngày từ Tiểu học Lê Lợi",
            },
            {
            ...
            },
            {
                ...
                "address": "9 Nguyễn Sinh Cung, P. Vỹ Dạ, TP. Huế",
                "lat": 16.4490, "lng": 107.5910, "credit": 300000,
        ...
        extra_workers = [
            {
                ...
                "email": "minhanh.nguyen@student.hueuni.edu.vn", "phone_number": "0912010101",
                "address": "10 Điện Biên Phủ, P. Vĩnh Ninh, TP. Huế",
                "lat": 16.4615, "lng": 107.5920, "tier": "gold",
                "elo": 1250, "band": "good",
                "school": "Đại học Ngoại Ngữ - Đại học Huế", "major": "Sư phạm Tiếng Anh",
                "has_vehicle": True, "gender": "female",
                "skills": ["tieng_anh", "ielts", "toan", "tieu_hoc", "cap_1", "kien_nhan"],
                "qualifications": ["Sinh viên ĐH Ngoại Ngữ - ĐH Huế — CCCD & Bằng khen đã duyệt", "IELTS 8.0", "Tỷ lệ hoàn thành 99%"],
                "summary": "Sinh viên ĐH Ngoại Ngữ - ĐH Huế — Hạng Vàng · ELO 1.250, chuyên gia sư Tiếng Anh giao tiếp (IELTS 8.0) cho tiểu học & THCS, tỷ lệ hoàn thành 99%.",
                "jobs_done": 38, "rating": 4.95,
            },
            {
                "username": "worker_hoangnam", "first_name": "Hoàng Nam", "last_name": "Lê",
                "email": "hoangnam.le@dhsphue.edu.vn", "phone_number": "0912020202",
                "address": "35 Nguyễn Huệ, P. Phú Hội, TP. Huế",
                "lat": 16.4665, "lng": 107.5965, "tier": "diamond",
                "elo": 1420, "band": "trusted",
                "school": "Đại học Sư Phạm - Đại học Huế", "major": "Giáo dục Thể chất",
                "has_vehicle": True, "gender": "male",
                "skills": ["dontre", "an_toan_giao_thong", "the_thao", "bang_lai_a1", "so_cap_cuu"],
                "qualifications": ["Sinh viên ĐH Sư Phạm - ĐH Huế", "Bằng lái xe A1 đã đối soát", "Mũ bảo hiểm trẻ em chuẩn"],
                "summary": "Sinh viên ĐH Sư Phạm Huế — Hạng Kim Cương · ELO 1.420, có xe máy riêng kèm bằng lái A1 đã đối soát, chuyên đón trẻ an toàn các khung giờ tan học.",
                "jobs_done": 52, "rating": 4.9,
            },
            {
                "username": "worker_thao", "first_name": "Phương Thảo", "last_name": "Trần",
                "email": "phuongthao.tran@student.hueuni.edu.vn", "phone_number": "0912030303",
                "address": "18 Trần Cao Vân, P. Phú Hội, TP. Huế",
                "lat": 16.4650, "lng": 107.5990, "tier": "silver",
                "elo": 1100, "band": "normal",
                "school": "Khoa Giáo dục Mầm non - ĐH Sư Phạm Huế (MN)", "major": "Giáo dục Mầm non",
            ...
            },
            {
                ...
                "email": "minhduc.pham@husc.edu.vn", "phone_number": "0912040404",
                "address": "77 Nguyễn Huệ, P. Phú Hội, TP. Huế",
                "lat": 16.4635, "lng": 107.5960, "tier": "bronze",
                "elo": 980, "band": "normal",
                "school": "Đại học Khoa học - Đại học Huế", "major": "Khoa học Máy tính",
                "has_vehicle": False, "gender": "male",
                "skills": ["toan", "lap_trinh", "cap_2", "cap_3"],
                "qualifications": ["Mới tham gia nền tảng", "Giải Nhì Tin học sinh viên ĐH Khoa học Huế"],
                "summary": "Sinh viên ĐH Khoa học (ĐHHH) — Hạng Đồng · ELO 980, mới tham gia nền tảng, nhận dạy Toán & Lập trình tư duy cấp 2-3.",
                "jobs_done": 2, "rating": 4.5,
            },
            {
                "username": "worker_quynh", "first_name": "Quỳnh Chi", "last_name": "Vũ",
                "email": "quynhchi.vu@husc.edu.vn", "phone_number": "0912050505",
                "address": "144 Hùng Vương, P. Vĩnh Ninh, TP. Huế",
                "lat": 16.4605, "lng": 107.5915, "tier": "silver",
                "elo": 1040, "band": "normal",
                "school": "Đại học Khoa học - Đại học Huế", "major": "Tâm lý học",
                "has_vehicle": True, "gender": "female",
                "skills": ["trong_tre", "tam_ly", "ke_chuyen", "ho_tro_hoc_tap"],
                "qualifications": ["Sinh viên Tâm lý ĐH Khoa học - ĐH Huế", "Kinh nghiệm 2 năm giữ bé"],
                "summary": "Sinh viên Tâm lý ĐH Khoa học Huế — Hạng Bạc · ELO 1.040, đang có 1 đơn bị phạt trừ ELO do hỏng xe, đã nộp đơn kháng cáo chờ Admin duyệt.",
            ...
            },
            {
                ...
                "email": "thanhmai.bui@dhsphue.edu.vn", "phone_number": "0912080808",
                "address": "28 Lê Duẩn, P. Thủy Biều, TP. Huế",
                "lat": 16.4590, "lng": 107.6060, "tier": "silver",
                "elo": 1150, "band": "normal",
                "school": "Đại học Sư Phạm - Đại học Huế", "major": "Giáo dục Tiểu học",
                "has_vehicle": False, "gender": "female",
                "skills": ["tieu_hoc", "re_chan", "tieng_viet", "toan_tieu_hoc"],
                "qualifications": ["Sinh viên ĐH Sư Phạm - ĐH Huế năm 4", "Kinh nghiệm dạy phụ đạo tiểu học 3 năm"],
                "summary": "Sinh viên Sư Phạm Huế — Hạng Bạc · ELO 1.150, chuyên rèn chữ và kèm Toán tiểu học khu vực Vĩnh Ninh, Phú Hội.",
                "jobs_done": 21, "rating": 4.85,
            },
            {
                "username": "worker_giahan", "first_name": "Gia Hân", "last_name": "Chu",
                "email": "giahan.chu@ktehue.edu.vn", "phone_number": "0912090909",
                "address": "279 Chi Lăng, P. Phú Hòa, TP. Huế",
                "lat": 16.4555, "lng": 107.6020, "tier": "gold",
                "elo": 1290, "band": "good",
                "school": "Đại học Kinh Tế - Đại học Huế", "major": "Tài chính Quốc tế",
                "has_vehicle": True, "gender": "female",
                "skills": ["tieng_anh", "toan", "cap_2", "ielts"],
                "qualifications": ["Sinh viên ĐH Kinh Tế - ĐH Huế — IELTS 7.5", "Gia sư 3 năm cho học sinh khu vực Phú Hội, Vĩnh Ninh"],
                "summary": "Sinh viên ĐH Kinh Tế Huế — Hạng Vàng · ELO 1.290, gia sư Tiếng Anh & Toán cấp 2 khu vực trung tâm TP. Huế, có xe máy di chuyển linh hoạt.",
            ...
            },
            {
                ...
                "email": "vietdung.ngo@hueic.edu.vn", "phone_number": "0912101010",
                "address": "268 Bà Triệu, P. Phú Hòa, TP. Huế",
                "lat": 16.4535, "lng": 107.6045, "tier": "silver",
                "elo": 1180, "band": "normal",
                "school": "Đại học Sư Phạm Kỹ Thuật - Đại học Huế", "major": "Kỹ thuật Điện tử",
                "has_vehicle": True, "gender": "male",
                "skills": ["toan", "vat_ly", "cap_3", "dontre"],
                "qualifications": ["Sinh viên ĐH Sư Phạm Kỹ Thuật - ĐH Huế", "Bằng lái A1", "Gia sư Lý cấp 3 từ năm nhất"],
                "summary": "Sinh viên ĐH Sư Phạm Kỹ Thuật Huế — Hạng Bạc · ELO 1.180, nhận dạy Vật Lý cấp 3 và đón trẻ khu vực Phú Hòa, Vĩnh Ninh.",
        ...
        job6 = JobPost.objects.create(
            ...
            location_note="48 Võ Thị Sáu, P. Vĩnh Ninh, TP. Huế",
        ...
        job8 = JobPost.objects.create(
            ...
            job_type=JobPost.JobType.PICKUP,
            title="Đón bé tan Tiểu học Lê Lợi về Vĩnh Ninh",
            description="Đón bé lúc 16h30 tại cổng Tiểu học Lê Lợi, đưa về nhà phường Vĩnh Ninh. Đã trang bị mũ bảo hiểm trẻ em.",
            ...
            location_note="Cổng Tiểu học Lê Lợi, 5 Lê Lợi → P. Vĩnh Ninh, TP. Huế",
            type_data={"school_or_pickup_place_name": "Tiểu học Lê Lợi",
                       "child_age_group": "6-11", "number_of_children": 1,
        ...
        tasks_configs = [
            ...
            },
            {
                ...
                "loc": "Chung cư Đống Đa, Đường Đống Đa, P. Phú Hội, TP. Huế",
