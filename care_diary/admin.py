...
class CareDiaryEntryAdmin(admin.ModelAdmin):
    # N2 — hiển thị + lọc theo assessment_type để QA/support tra cứu nhanh
    # entry nào là tutoring/childcare qua admin panel.
    list_display = ('id', 'task', 'worker', 'assessment_type',
                    'completion_percent', 'created_at')
    list_filter = ('assessment_type', 'completion_percent', 'created_at')
