...
- Tọa độ GPS thực tế tại khu vực TP. Huế.
"""
...
SPECIALIST_CAREPARTNERS = [
    # ── 1. ÂM NHẠC & ĐÀN PIANO / ORGAN / GUITAR ──
    {
        ...
        'address': '20 Lê Lợi, P. Vĩnh Ninh, TP. Huế (bờ sông Hương)',
        'lat': 16.4645,
        'lng': 107.5925,
        'gender': 'female',
    ...
    },
    {
        ...
        'qualifications': [
            'Cử nhân Sư phạm Âm nhạc - ĐH Sư Phạm - ĐH Huế',
    ...
    # ── 2. MỸ THUẬT & HỘI HỌA ──
    {
        ...
        'address': '42 Phan Bội Châu, P. Phú Hội, TP. Huế (gần ĐH Khoa học)',
        'lat': 16.4660,
        'lng': 107.5950,
        'gender': 'female',
        'school': 'Đại học Khoa học - Đại học Huế',
        'major': 'Mỹ thuật & Sư phạm Mỹ thuật',
    ...
    # ── 3. CNTT & LẬP TRÌNH ──
    {
        ...
        'address': '77 Nguyễn Huệ, P. Phú Hội, TP. Huế (ĐH Khoa học - ĐHHH)',
        'lat': 16.4640,
        'lng': 107.5965,
        'gender': 'male',
        'school': 'Đại học Khoa học - Đại học Huế',
        ...
        'qualifications': [
            'Sinh viên năm 3 Khoa CNTT - ĐH Khoa học - ĐH Huế',
            'Giải Nhì lập trình Tin học trẻ Quốc gia',
            'Giảng viên bán thời gian dạy Scratch & Python cho trẻ em tại trung tâm STEM Huế',
        ],
    ...
    # ── 4. NGOẠI NGỮ CHUYÊN SÂU (ANH, TRUNG, NHẬT, PHÁP) ──
    {
        ...
        'address': '8 Điện Biên Phủ, P. Vĩnh Ninh, TP. Huế (gần ĐH Ngoại Ngữ)',
        'lat': 16.4625,
        'lng': 107.5920,
        'gender': 'female',
        ...
        'qualifications': [
            'Cử nhân Sư phạm Tiếng Anh - ĐH Ngoại Ngữ - ĐH Huế',
    ...
    },
    {
        ...
        'address': '30 Điện Biên Phủ, P. Vĩnh Ninh, TP. Huế',
        'lat': 16.4618,
        'lng': 107.5918,
        'gender': 'female',
        'school': 'Đại học Ngoại Ngữ - Đại học Huế',
        ...
        'qualifications': [
            'Sinh viên năm 4 Khoa Ngôn ngữ & Văn hóa Trung Quốc - ĐH Ngoại Ngữ - ĐH Huế',
    ...
    },
    {
        ...
        'address': '15 Lê Ngô Cát, P. Vĩnh Ninh, TP. Huế',
        'lat': 16.4600,
        'lng': 107.5925,
        'gender': 'male',
        'school': 'Đại học Ngoại Ngữ - Đại học Huế',
        ...
        'qualifications': [
            'Cử nhân Ngôn ngữ Nhật Bản - ĐH Ngoại Ngữ - ĐH Huế',
    ...
    },
    {
        ...
        'address': '6 Phạm Ngũ Lão, P. Phú Hội, TP. Huế',
        'lat': 16.4668,
        'lng': 107.5980,
        'gender': 'female',
        'school': 'Đại học Ngoại Ngữ - Đại học Huế',
        ...
        'qualifications': [
            'Sinh viên năm cuối Khoa Pháp ngữ - ĐH Ngoại Ngữ - ĐH Huế',
            'Chứng chỉ tiếng Pháp Quốc tế DELF B2',
            'Kèm học sinh trường Song ngữ Pháp - Việt tại Huế',
        ],
    ...
    # ── 5. TIỂU HỌC & LUYỆN CHỮ ĐẸP ──
    {
        ...
        'address': '136 Đội Cung, P. Vĩnh Ninh, TP. Huế',
        'lat': 16.4650,
        'lng': 107.5910,
        'gender': 'female',
        'school': 'Đại học Sư Phạm - Đại học Huế',
        ...
        'qualifications': [
            'Sinh viên năm 4 Khoa Giáo dục Tiểu học - ĐH Sư Phạm - ĐH Huế',
    ...
    },
    {
        ...
        'address': '26 Nguyễn Công Trứ, P. Vĩnh Ninh, TP. Huế',
        'lat': 16.4595,
        'lng': 107.5905,
        'gender': 'female',
        'school': 'Đại học Sư Phạm - Đại học Huế',
        ...
        'qualifications': [
            'Cử nhân Sư phạm Ngữ Văn - ĐH Sư Phạm - ĐH Huế',
    ...
    # ── 6. MẦM NON & TRÔNG TRẺ ──
    {
        ...
        'address': '10 Hoàng Hoa Thám, P. Vĩnh Ninh, TP. Huế',
        'lat': 16.4630,
        'lng': 107.5935,
        'gender': 'female',
        'school': 'Khoa Giáo dục Mầm non - ĐH Sư Phạm Huế (MN)',
        'major': 'Giáo dục Mầm non',
        'skills': ['trong_tre', 'mam_non', 'choi_cung_be', 'so_cap_cuu', 'nau_an', 'kien_nhan'],
        'qualifications': [
            'Sinh viên năm 4 Khoa Giáo dục Mầm non - ĐH Sư Phạm - ĐH Huế',
    ...
    },
    {
        ...
        'address': '6 Ngô Quyền, P. Vĩnh Ninh, TP. Huế (gần BV Đại học Y Dược Huế)',
        'lat': 16.4610,
        'lng': 107.5955,
        'gender': 'female',
        'school': 'Đại học Y Dược - Đại học Huế',
        'major': 'Điều dưỡng Nhi khoa (Năm 4)',
        'skills': ['trong_tre', 'so_cap_cuu', 'mam_non', 'kien_nhan'],
        'qualifications': [
            'Sinh viên năm 4 Điều dưỡng Nhi khoa - ĐH Y Dược - ĐH Huế',
    ...
    # ── 7. ĐƯA ĐÓN TRẺ AN TOÀN ──
    {
        ...
        'address': '16 Bà Triệu, P. Phú Hội, TP. Huế (gần BV Trung ương Huế)',
        'lat': 16.4655,
        'lng': 107.5975,
        'gender': 'male',
        'school': 'Đại học Y Dược - Đại học Huế',
        ...
        'qualifications': [
            'Sinh viên năm 4 Bác sĩ Đa khoa - ĐH Y Dược - ĐH Huế',
    ...
    },
    {
        ...
        'address': '70 An Dương Vương, P. Phú Hội, TP. Huế',
        'lat': 16.4648,
        'lng': 107.5942,
        'gender': 'male',
        'school': 'Đại học Sư Phạm Kỹ Thuật - Đại học Huế',
        'major': 'Kỹ thuật Giao thông',
        'skills': ['don_tre', 'so_cap_cuu', 'an_toan', 'dung_gio'],
        'qualifications': [
            'Sinh viên năm cuối ĐH Sư Phạm Kỹ Thuật - ĐH Huế',
            'Thông thạo đường xá TP. Huế, xe Lead có cốp lớn để cặp sách cho bé',
        ],
